<%@ Page Title="Password Generator" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PasswordGenerator.aspx.cs" Inherits="RajLab.PasswordGenerator" %>
...
<span>Simple random password generator generates random passwords using following character
    ...
    <asp:PlaceHolder ID="passwordsPlaceHolder" runat="server"></asp:PlaceHolder></asp:Content>
