<%@ Page Title="GUID Generator" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GuidGenerator.aspx.cs" Inherits="RajLab.GuidGenerator" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        digits with groups separated by hyphens, such as 21EC2020-3AEA-1069-A2DD-08002B30309D</div>
    <table class="style1">
        <tr>
